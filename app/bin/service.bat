...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    --Description "Apache Tomcat 7.0.67 (Geoserver + Spatium SWDA)" ^
    ...
    --StartParams start ^
    --StopParams stop ^
    --JvmOptions "-Dcatalina.home=%CATALINA_HOME%;-Dcatalina.base=%CATALINA_BASE%;-Djava.endorsed.dirs=%CATALINA_HOME%\endorsed;-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties;-Dkeystore.file=conf/cert.jks;-Dkeystore.password=lomiarz;-Ddb.username=postgres;-Ddb.password=Daniel123;-Ddb.url=jdbc:postgresql://localhost:5434/swda;-Dgeoserver.url=http://localhost:8080/geoserver;-DGEOSERVER_HOME="%CATALINA_BASE%;-DGEOSERVER_DATA_DIR="%CATALINA_BASE%\geoserver-data;-Dcom.sun.management.jmxremote;-Dcom.sun.management.jmxremote.port=8086;-Dcom.sun.management.jmxremote.ssl=false;-Dcom.sun.management.jmxremote.authenticate=false" ^
    --JvmMs 128 ^
    --JvmMx 2048
